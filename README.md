...
An ML-powered cybersecurity threat detection and analysis dashboard built with Python and Streamlit. Features real-time network traffic monitoring, anomaly detection using Isolation Forest, and attack classification using Random Forest with 95% accuracy.
